    ...
    <b-list-group>
      ...
      >
        ...
        <div class="sumPayAmount">
          ...
          <span>{{summary.sumPayAmount}}</span>
        </div>
        <div class="shareAmount">
          <font-awesome-icon icon="yen-sign" class="fa-xs" />
          <span>{{summary.shareAmount + ' ' + summary.shareType}}</span>
          <font-awesome-icon
...
export default {
  ...
  methods: {
    search() {
      ...
      axios
        .all([
          Utils.httpGet("showSummaryPay", params),
          Utils.httpGet("showSummaryByCategory", params)
        ])
        .then(responses => {
