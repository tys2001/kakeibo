<template>
  <div class="container-box">
    ...
    <div class="button-column">
      <b-button pill variant="secondary" class="button" @click="clear"><font-awesome-icon icon="trash-alt"/></b-button>
      <b-button pill variant="secondary" class="button" @click="back"><font-awesome-icon icon="backspace"/></b-button>
